...
LIBS          = $(SUBLIBS) -L /usr/local/lib/ -l:libopencv_core.so.4.3 -l:libopencv_imgproc.so.4.3 -l:libopencv_imgcodecs.so.4.3 -l:libopencv_highgui.so.4.3 levmar/liblevmar.a -lstdc++ -lglut -lGLU -lopenblas -L/home/catriona/Qt5.9.9/5.9.9/gcc_64/lib -lQt5OpenGL -lQt5Widgets -lQt5Gui -lQt5Xml -lQt5Core -lGL -lpthread 
AR            = ar cqs
RANLIB        = 
SED           = sed
STRIP         = strip
